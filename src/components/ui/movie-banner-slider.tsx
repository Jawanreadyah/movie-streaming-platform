        ...
        <div className="absolute bottom-4 left-0 right-0 z-30 flex justify-center items-center gap-2">
          {movies.map((movie, index) => (
            ...
            >
              ...
              {/* Rating Tooltip */}
              <div className={`absolute bottom-full mb-2 -translate-x-1/2 left-1/2 bg-black/80 backdrop-blur-sm px-2 py-1 rounded-md text-white text-xs flex items-center gap-1 transition-opacity duration-200 ${
